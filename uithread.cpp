...
void UIThread::run()
{
    while (!_isStop)
    {
        ...
        case JM_UI_MSG_BOX_ADD_BTN:
            _manager->messageBoxPresenter()->addBtn(QString::fromUtf8(text));
            break;
        case JM_UI_MSG_BOX_SET_MSG:
            _manager->messageBoxPresenter()->setMsg(QString::fromUtf8(text));
            break;
        case JM_UI_MSG_BOX_SET_TITLE:
            _manager->messageBoxPresenter()->setTitle(QString::fromUtf8(text));
            break;
        ...
        case JM_UI_MENU_ADD_ITEM:
            _manager->menuPresenter()->addItem(QString::fromUtf8(text));
            break;
        ...
        case JM_UI_TC_ADD_BTN:
            _manager->troubleCodePresenter()->addBtn(QString::fromUtf8(text));
            break;
        ...
        case JM_UI_LD_ADD_BTN:
            _manager->liveDataPresenter()->addBtn(QString::fromUtf8(text));
            break;
        case JM_UI_LD_SET_VALUE:
            {
                QStringList strl = QString::fromUtf8(text).split(QChar('|'));
